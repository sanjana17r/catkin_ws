...
"""autogenerated by genpy from robot_msgs/MoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveActionFeedback(genpy.Message):
  ...
  _type = "robot_msgs/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_msgs/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = robot_msgs.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_msgs.msg.MoveFeedback()
