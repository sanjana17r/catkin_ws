...
(cl:defclass <MoveActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type robot_msgs-msg:MoveGoal
    :initform (cl:make-instance 'robot_msgs-msg:MoveGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<MoveActionGoal> is deprecated: use robot_msgs-msg:MoveActionGoal instead.")))
