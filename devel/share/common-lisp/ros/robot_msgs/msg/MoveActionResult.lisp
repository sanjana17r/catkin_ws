...
(cl:defclass <MoveActionResult> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (result
    :reader result
    :initarg :result
    :type robot_msgs-msg:MoveResult
    :initform (cl:make-instance 'robot_msgs-msg:MoveResult)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveActionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveActionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<MoveActionResult> is deprecated: use robot_msgs-msg:MoveActionResult instead.")))
